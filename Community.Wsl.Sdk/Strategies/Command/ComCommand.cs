...
public class ComCommand : ICommand
{
    ...
    {
        var stdinWriter = CreateStdInWriter(options, stdin);

        var stdoutReader = CreateStdOutReader(options, stdout);

        var stderrReader = CreateStdErrReader(options, stderr);
    ...
    private static StreamReader CreateStdErrReader(
        CommandExecutionOptions options,
        NativePipe stderr
    )
    {
    ...
    private static StreamReader CreateStdOutReader(
        CommandExecutionOptions options,
        NativePipe stdout
    )
    {
    ...
    private static StreamWriter CreateStdInWriter(CommandExecutionOptions options, NativePipe stdin)
    {
